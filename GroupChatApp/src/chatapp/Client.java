...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        groupNumberTextField = new javax.swing.JTextField();
        ...
        groupNumberTextField.setText("Group Number Here....");
        groupNumberTextField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                groupNumberTextFieldFocusLost(evt);
            }
        });
        groupNumberTextField.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                groupNumberTextFieldPropertyChange(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(groupNumberTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(43, 43, 43)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel7)
                                    .addComponent(groupNumberTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(LogIn))
                            .addGroup(layout.createSequentialGroup()
    ...
    void RefreshFriendList(){ 
        ...
        try {
            ...
            String sendRequest = "RefreshFriends"+":"+groupId;
    ...
    private void LogInMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LogInMouseClicked
        ...
        if(LogIn.getText().equals("Log Out"))
        {
            try {
                ...
                groupNumberTextField.setText("Group Number goes here...");
                for (TEstJFRAme cb : chatBoxRecord.values()){
        ...
        if(name.equals("") || passd.equals("")){
            ...
            try{
                  ...
                  groupId = Integer.parseInt(groupNumberTextField.getText().toString());
              }
              catch (NumberFormatException n){
                  JOptionPane.showMessageDialog(null, "Enter a valid Port or Group number");
            ...
            try {
                ...
                String msg = "Auth"+ ":" +name +":" + passd + ":" + ipAdresses.getSelectedItem() +":"+Integer.parseInt(JChatPort.getText().toString())+":"+groupId;
                dout = new DataOutputStream(s.getOutputStream());
                dout.writeUTF(msg);
                System.out.println("data sent");

                din = new DataInputStream(s.getInputStream());
                String read1 = din.readUTF();
                String read = read1.split(":")[0];
                String isMaster = read1.split(":")[1];
                if(read.equals("Valid")){
                    ...
                    if(isMaster.equals("YES")){
                        System.out.println("First user so its a master for staring the chat");
                        master = true;
                    }
                    System.out.println("Client is Mr:"+client);
                    JOptionPane.showMessageDialog(null, "Logged In Successfully");
                    
                    openNewDisplay(groupId+"");
                }
                else{
    ...
    private void groupNumberTextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_groupNumberTextFieldFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_groupNumberTextFieldFocusLost

    private void groupNumberTextFieldPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_groupNumberTextFieldPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_groupNumberTextFieldPropertyChange

    
    void openNewDisplay(String selected){
        
        
        TEstJFRAme c = new TEstJFRAme();
...
//        
//  all commented for group chat online test in chat
...
//
//      for chat online friends selected
...
//        }
        ...
        System.out.println("Chat box record " + chatBoxRecord.entrySet());
        chatBoxRecord.put(selected,c);
        System.out.println("Chat box record " + chatBoxRecord.entrySet());
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                c.setClientName(client);
                String membersDetail = RequestMembersDetail();
//                String ip = RequestIP(selected.split("-")[0]);
//                c.setIPAddress(ip);
                c.setFriendName(selected);
                c.setVisible(true);
                String membersList = RequestMembersDetail();
                c.setMembers(membersDetail);
...
//                c.setFriendPort(port);
    ...
    private String RequestMembersDetail() {   
        try {
                Socket s = new Socket(serverIp,authServerPort);
                String msg = "RequestMembersDetail"+ ":" + groupId;
                dout = new DataOutputStream(s.getOutputStream());
                dout.writeUTF(msg);
                System.out.println("data sent");
                ...
                System.out.println("************Sent Memebers detail from server is "+ ipMsg);
                s.close();
                return ipMsg;      
            } catch (IOException ex) {
                Logger.getLogger(Client.class.getName()).log(Level.SEVERE, null, ex);
...
//                            RefreshFriendList();
                            ...
                            if(msg.split(":")[0].equals("MembersList")){
                                System.out.println("New group list arrived ");
                                String serverData = msg.substring(msg.indexOf(":") + 1);
                                System.out.println("Server data of members " + serverData);
                                updateGroupList(serverData);
                            }
                            else{
                                ...
                                if(master)
                                    broadCastMessage(sender+":"+from+":"+message,sender);
...
//                                }
                                ...
                                chatBoxRecord.get(groupId+"").printMessage(sender,message);
                ...
                private void updateGroupList(String list) {
                    System.out.println("Updating group list " + groupId);
                    System.out.println("chatBOxrecord entry set " + chatBoxRecord.entrySet());
                    setGroupMembers(list);
                    chatBoxRecord.get(groupId+"").setMembers(groupMembeList.get(0));
                }
                
                 void setGroupMembers(String str){
                    System.err.println("Setting members of client MEMBERS** :-: " + str);
                    String mems[] = str.split("\\$");
                    groupMembeList.clear();
                    for(String s: mems){
                        System.out.println("Adding : " + s);
                        groupMembeList.add(s);
                    }
                    System.err.println("Clients Members setup successful");
                }
                
                void broadCastMessage(String message,String from){
                    int i=0;
                    System.out.println("\u001B[35m"+"Broadcaster ip address and port "+ from + " " );
                    String ipFrom = RequestIP(from);
                    int portFrom = RequestPort(from);
                    for(String ip : groupMembeList){
                        String ipAddress = ip.split(":")[0];
                        int port = Integer.parseInt(ip.split(":")[1]);
                        System.out.println(ipAddress+".equals("+ipFrom+")"+" && "+ "("+port +"==" +portFrom+")");
                        if(i==0 ){
                            i++;
                            System.out.println("NOt sent to this");
                        }
                        else{
                             System.err.println("Broadcasting ************ Sending message to " + ip + " --> " + message);
    ...
    private javax.swing.JTextField groupNumberTextField;
    ...
    HashMap<String, TEstJFRAme> chatBoxRecord = new HashMap<>();
    String serverIp = "localhost";
    
    ArrayList<String> groupMembeList = new ArrayList<>(); 
    Thread t1;
}
