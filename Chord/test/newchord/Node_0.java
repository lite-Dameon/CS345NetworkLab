 ...
 * @author khyati
 */
public class Node_0 extends javax.swing.JFrame {
     Node a = new Node(3,0);
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Node_0.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
